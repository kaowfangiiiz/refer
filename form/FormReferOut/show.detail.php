                            ...
                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                <div class="tab-pane fade active show" id="custom-tabs-one-home" role="tabpanel"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class=" col-md-4">
                                            <input type="text " class="form-control" id="hosReferDes" name="hosReferDes"
                                                style="width: 100%;" readonly />
                                        </div>

                                        <input type="hidden" class="form-control" id="codeReferDes" name="codeReferDes"
                                            style="width: 100%;" readonly />
                                        ...
                                        <div class="input-group-prepend col-md-5  col-lg-5 ">
                                            ...
                                            <input type="text" class="form-control" id="reservationtimeExpireDes"
                                                name="reservationtimeExpireDes" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-auto">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control " type="text" style="width: 100%;"
                                                    id="getStationService" name="getStationService" readonly />
                                                <label>ห้องตรวจปลายทาง</label>
                                                <input class="form-control " type="text" style="width: 100%;"
                                                    id="getStationServiceDestinationDes"
                                                    name="getStationServiceDestinationDes" readonly />
                                        ...
                                        <div class="col-md-auto">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="lvAcityDes"
                                                    name="lvAcityDes" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-auto">
                                            <!-- select -->
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="clinicgroupDes"
                                                    name="clinicgroupDes" readonly>
                                            </div>
                                        ...
                                        <div class="col-md-auto">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control " name="TypeptDes" id="TypeptDes"
                                                    type="text " readonly />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-auto">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control " name="servicePlaneDes" id="servicePlaneDes"
                                                    type="text " readonly />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="carReferDes"
                                                    id="carReferDes" aria-describedby="helpId" placeholder="" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>เหตุผลการส่ง :</label>
                                                <input type="text" class="form-control" name="causeReferoutDes"
                                                    id="causeReferoutDes" aria-describedby="helpId" placeholder=""
                                                    readonly>
                                        ...
                                        <div class="col-md-4" id="otherCauseReferout" style=" display: none;">
                                            <div class="form-group">
                                                <label>อื่น :</label>
                                                <input type="text" class="form-control" name="otherCauseReferout"
                                                    id="showotherCauseReferout" placeholder="ป้อนเหตุผล" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control select2" name="Typept_Des" id="Typept"
                                                    width="100%;" disabled> </select>
                                            </div>
                                        </div>
                                        <div class="col-md">
                                            <div class="form-group">
                                                <label class="col-md-autocol-form-label">Level of Acuity:</label>
                                                <select class="form-control lvlactual" width="100%;"
                                                    name="levelActual_Des" id="levelActual" disabled
                                                    onchange="updateColor(event)">
                                                </select>
                                                <input type="hidden" name="colorLvAc" id="colorLvAc">
                                                <input type="text" class="form-control" id="levelActualShow"
                                                    name="levelActualShow" readonly style="display:none">
                                        ...
                                        <div class="col-md">
                                            <div class="form-group">
                                                <label>วิธีการนำส่ง :</label>
                                                <select class="form-control load_des" id="loads" name="loads_des"
                                                    width="100%;" disabled> </select>
                                            </div>
                                        </div>
                                        <div class="col-md">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control  " style="width: 100%;"
                                                    name="coordinateIsDes" id="coordinateIsDes" disabled>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Service Plane :</label>
                                                    <select class="form-control select2" name="sevicePlanDes"
                                                        id="servicePlane" width="100%;" multiple="multiple" disabled>
                                                    </select>
                                                    <input type="text" class="form-control" id="serviceTextPlaneDes"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <i class="far fa-clock"></i> <input type="text"
                                                        class="form-control float-left" id="reservationtime"
                                                        name="reservationtimeExpireDes" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                                <div class="col-md-auto col-lg-auto">
                                                    ...
                                                    <textarea name="cc" id="cc" title="Contents" class="col-md-12"
                                                        readonly></textarea>
                                                </div>
                                                <div class="col-md-auto col-lg-auto">
                                                    <div align="left">
                                                    ...
                                                    <textarea name="digonosis" id="Diagonosis" class="col-md-12"
                                                        title="Diagonosis" readonly></textarea>
                                                </div>
                                                <div class="col-md-auto col-lg-auto">
                                                    <label>Management</label>
                                                    <textarea title="Contents" name="managementDes" id="managementDes"
                                                        class="col-md-12" readonly></textarea>
                                                </div>
                                                ...
                                                <div class="col-md-auto col-lg-auto">
                                                    ...
                                                    <textarea name="digonosisDes" id="DiagonosisDes" class="col-md-12"
                                                        readonly></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea name="ccMain" id="ccMain" class="col-md-12"
                                                        title="Contents" readonly>ccMain</textarea>
                                                </div>
                                                <div class="col-md-12">
                                                    <div align="left">
                                                        <div class="row">
                                                    ...
                                                    <textarea name="ccDestination" class="col-md-12" id="ccDestination"
                                                        title="Contents" readonly>ccDestination</textarea>
                                                </div>
                                        ...
                                        <div align="right">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="PutRefDes()"
                                                style="display: none;" id="UpdateCaseRefDes">
                                                Updateข้อมูลไปให้ต้นทาง </button>

                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                style="display: none;" id="open-modal-case-referHocode"
                                                data-bs-target="#mmmodalReferCode"> เปลี่ยนสถานพยาบาลปลายทาง
                                            </button>
                                            <!-- ยกเลิกต้นทาง -->
                                            ...
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                                style="display: none;" id="open-modal-case-referHosCodeDes"
                                                data-bs-target="#mmmodalReferCode">
                                                ส่งต่อ
                                            </button>
                                            <button type="button" class="btn btn-default" data-bs-toggle="modal"
                                                style="display: none;" id="open-modal-case-referin"
                                                data-bs-target="#mmmodal">
                                                ส่งตัวกลับ
                                            </button>
                                            <button type="button" id="UpStatusReferOutDes" style="display:none;"
                                                class="btn btn-success " onclick="UpStatusReferOutIsSave()">
                                                รับ Refer </button>
                                            <button type="button" class="btn btn-warning" id="refuse-button"
                                                style="display:none;" data-bs-toggle="modal"
                                                data-bs-target="#mmmodal-refuse-case">ปฏิเสธการส่งตัว </button>
                                            <button type="button" class="btn btn-success" id="refuse-button-drv"
                                                data-bs-toggle="modal" style="display:none;"
                                                data-bs-target="#mmmodal-refuse-in">รายละเอียดแนบการส่งตัว</button>
                                            <button type="submit" class="btn btn-info"> Download แบบฟอร์มใบส่งตัว
                                            </button>
                                            <button type="button" class="btn btn-primary" style="display:none;"
                                                id="UpdateRefRefer" onclick="PutCaseReferOut()"> Update
                                                ข้อมูลไปให้ปลายทาง
                                            </button>
                                            <span id="referCancle"></span>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                style="display: none;" id="open-modal-case-referout-cancelorg"
                                                data-bs-target="#mmmodalCancleOrg">
                                                ยกเลิกการส่งตัว
                                            </button>
                                        </div>
                                        <!-- //! Modlaยกเลิการส่งตัว  -->
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label
                                                                for="exampleInputEmail1">โปรดระบุเหตุผลในการยกเลิกการส่ง
                                                            </label>
                                                            <select class="form-control" id="inputCancleReferoutOrg"
                                                                name="inputCancleReferoutOrg"> </select>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="button" class="btn btn-secondary"
                                                        ...
                                                        <button type="button" class="btn btn-success"
                                                            id="cancleReferOutOrg"
                                                            onclick="cancleReferoutOrg()">ยืนยันการยกเลิก</button>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class=" col-md-6">
                                                                <label
                                                                    class="col-md-autocol-form-label">สถานพยาบาลปลายทาง</label>
                                                                <select class="form-control " id="hosCodeRefer"
                                                                    onchange="getStationServiceDestinations(this.value)"
                                                                    name="hosCodeRefer" style="width: 100%;">

                                                                </select>
                                                            </div>
                                                            <div class=" col-md-6">
                                                                <label
                                                                    class="col-md-autocol-form-label">จุดบริการปลายทาง</label>
                                                                <select class="form-control "
                                                                    id="getStationServiceDestination"
                                                                    name="getStationServiceDestination"></select>
                                                            </div>
                                                            <div class="form-group" id="OtherCase">
                                                                <label for="exampleInputEmail1">Other Case</label>
                                                                <input type="text" class="form-control"
                                                                    id="inputOtherCase" name="inputOtherCase">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Close</button>
                                                        <button type="button" class="btn btn-success"
                                                            id="sendFromReferHoscodeUpdate"
                                                            onclick="sendFromReferhosCode()">ยืนยันการส่ง</button>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-select form-select-solid"
                                                                ...
                                                                data-allow-clear="true" id="deriveryService"
                                                                onchange="modalDerivery(this.value)">
                                                            </select>
                                                        </div>
                                                        <div class="form-group" id="OtherCaseSendRefer"
                                                            style="display: none;">
                                                            <label for="exampleInputEmail1">Other Case</label>
                                                            <input type="text" class="form-control"
                                                                id="inputOtherCaseDrv"
                                                                oninput="InputOtherCase(this.value)"
                                                                name="inputOtherCaseDrv">
                                                        </div>

                                                        <div class="form-group">
                                                            <label
                                                                for="exampleInputEmail1">รายละเอียดแนบการส่งตัว</label>
                                                            <input type="text" class="form-control"
                                                                id="inputDeriveryCase" name="inputDeriveryCase">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Close</button>
                                                        <button type="button" id="UpStatusReferOutDesResive"
                                                            class="btn btn-success "
                                                            onclick="SendReferIn()">ยืนยันการส่งตัว</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- //? ปฏิเสธการส่งตัว -->
                                        <div class="modal fade" id='mmmodal-refuse-case' tabindex="-1"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="input-refuse"
                                                                name="reasonInput"> </select>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="button" class="btn btn-secondary"
                                                        ...
                                                        <button type="button" class="btn btn-success"
                                                            id="cancleReferOutOrg"
                                                            onclick="RefuseReferOut()">ยืนยันการยกเลิก</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal fade" id='mmmodal-refuse-in' tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <textarea class="col-md-12" readonly
                                                                id="formDry"></textarea>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn  btn-secondary"
                            ...
                            <div class="form-group row">
                                <div class="card">
                                    <div class="card-header">
                                        <label for="inputName"
                                            class="col-md-2 col-form-label">รายละเอียดการใช้ยา</label>
                                    </div>
                                    <div class="card-body">
                        ...
                        <form class="form-horizontal">
                            <div class="form-group row">
                                <div class="card">
                                    <div class="card-header">
                                        <label for="inputName"
                                            class="col-md-2 col-form-label">รายละเอียดการส่งต่อ</label>
                                    </div>
                                    <div class="card-body">
