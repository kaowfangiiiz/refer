...
if ($_GET['onfrom'] === "showdetailreferback") { ?>
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form id="refer-back-form" method="POST" enctype="multipart/form-data"
            action="./form/FormReferBack/print.refer.back.php">
                    ...
                    <div class="card card-primary card-tabs">
                        <div class="card-header p-0 pt-1">
                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#consultfiles"
                                        data-toggle="tab">ConsultFile</a> </li>
                                ...
                                <div class="tab-pane fade active show" id="custom-tabs-one-home" role="tabpanel"
                                    ...
                                    <div class="form-group row">
                                        <div class=" col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="getStationService"
                                                id="getStationService" readonly>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" readonly name="telformreferback"
                                                    id="telformreferback">
                                            </div>
                                        </div>
                                        <div class=" col-md-6">
                                            <label class="col-md-autocol-form-label">สถานพยาบาลปลายทาง</label>
                                            <input type="text" class="form-control" readonly name="nameRefer"
                                                id="nameRefer">
                                    ...
                                    <div class="form-group row">
                                        <div class=" col-md-6">
                                            ...
                                            <input type="text" class="form-control" readonly name="movementFromReferBack"
                                                id="movementFromReferBack">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly name="doctorName"
                                                    id="doctorName">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly name="staffDoctorName"
                                                    id="staffDoctorName">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly name="reasonFormReferback"
                                                    id="reasonFormReferback">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly
                                                    name="reasonFormReferbackOther" id="reasonFormReferbackOther">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>ข้อมูลการนำยา</label>
                                                <input type="text" class="form-control" readonly name="refdrugReferBack"
                                                    id="refdrugReferBack">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly name="refReciveReferBack"
                                                    id="refReciveReferBack">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly
                                                    name="refReciveReferBackOther" id="refReciveReferBackOther">
                                                            ...
                                                            <table id="example2" class="table crollable-table">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>PR (ครั้ง/หน้า)</th>
                                                                        <th>RR (ครั้ง/นาที)</th>
                                                                        <th colspan="2" style="text-align:center">BP/mmHg
                                                                        </th>
                                                                        <th>Sp O2(%)</th>
                                                                    </tr>
                                                                </thead>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="progressNote" id="progressNote" class="col-md-12"
                                                    style="height:350px;" title="Contents" readonly></textarea>
                                            </div>
                                            <div class="col-md-12">
                                                <label>Final Diagnosis : การวินิจฉัยขั้นสุดท้าย</label>
                                                <textarea title="Contents" name="finalDianosis" id="finalDianosis"
                                                    style="height:50px;" class="col-md-12" readonly></textarea>
                                            </div>
                                            <div class="col-md-12">
                                                <div align="left">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea name="suggestionDianosis" class="col-md-12"
                                                                id="suggestionDianosis" title="Diagonosis"
                                                                readonly></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-auto">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal" aria-hidden="true">
                                                รายละเอียด ICD10
                                            </button>
                                        ...
                                        <div align="right">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                ...
                                                data-bs-target="#mmmodalReferCode"> ส่งต่อ
                                            </button>

                                            <button type="button" class="btn btn-info" id="suscecc-refer-back"
                                                style="display:none;" onclick="SendReferBack()">ยืนยันการรับตัว</button>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group" id="OtherCase">
                                                                ...
                                                                <input type="text" class="form-control" id="inputOtherCase"
                                                                    name="inputOtherCase">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <button type="button" class="btn btn-success"
                                                            ...
                                                            onclick="sendFromReferBackhosCode()">ยืนยันการส่ง</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
